...
builtins.__PYINA_SETUP__ = True
sys.path.append(os.path.abspath(os.path.curdir))
import pyina

# get version numbers, long_description, etc
AUTHOR = pyina.__author__
VERSION = pyina.__version__
LONG_DOC = pyina.__doc__ #FIXME: near-duplicate of README.md
#LICENSE = pyina.__license__ #FIXME: duplicate of LICENSE
